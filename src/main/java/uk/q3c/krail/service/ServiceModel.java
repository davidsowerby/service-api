 ...
 * The developer defines dependencies at class level, using Guice (see AbstractServiceModule in the implementation package) or {@link Dependency} annotations.  When a Service
...
public interface ServiceModel extends Serializable {
    ...
    ServiceInstanceGraph getInstanceGraph();

    ServiceClassGraph getClassGraph();
     ...
     * @return a list of immediate dependencies for {@code service}
     */
    List<Service> findInstanceDependencies(Service service, ServiceGraph.Selection selection);
}
