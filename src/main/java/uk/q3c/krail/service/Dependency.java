 ...
 * The annotation It is captured by the {@link * ServiceDependencyScanner} and its values translated for use with the {@link ServiceGraph}
 * <p>
 *
...
public @interface Dependency {
     ...
     * true, the dependency is optional.  See {@link ServiceModel#optionallyUses(ServiceKey, ServiceKey)}
     *
     ...
     * ServiceModel#alwaysDependsOn(ServiceKey, ServiceKey)}. If {@link #optional()} is false, and this value is false, this dependency is required only
     * in order to start the declaring service. See {@link ServiceModel#requiresOnlyAtStart(ServiceKey, ServiceKey)}.
     *
